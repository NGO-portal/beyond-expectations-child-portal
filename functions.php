...
add_action( 'after_setup_theme', 'be_child_portal_load_theme_textdomain' );
function be_child_portal_load_theme_textdomain() {
...
// Debug, to show what template file WP loads.
